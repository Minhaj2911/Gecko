...
class TaskFormTestCase(TestCase):
    ...
    def test_form_rejects_past_due_date(self):
        self.form_input['due_date']= timezone.now() - timedelta(days= 2)
        form= TaskForm(data= self.form_input)
        self.assertFalse(form.is_valid())
    ...
    def test_form_rejects_invalid_priority(self):
        self.form_input['priority']= ' '
        form= TaskForm(data= self.form_input)
        self.assertFalse(form.is_valid())
    
    def test_form_accepts_valid_priority(self):
        self.form_input['priority']= 2
        form= TaskForm(data= self.form_input)
        self.assertTrue(form.is_valid())
    ...
    def test_form_allows_editing_existing_form(self):
        ...
        self.assertEqual(existing_task.priority, 2)
